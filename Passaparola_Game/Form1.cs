...
namespace Passaparola_Game
{
    public partial class Form1 : Form
    {
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            if (soruno == 15)
            {
                richTextBox1.Text = "ABD Uzay Üssü ? ";
            ...
            if (soruno == 17)
            {
                richTextBox1.Text = "Soruyu geçmek için kullanılan kelime ? ";
            ...
            if (soruno == 18)
            {
                richTextBox1.Text = "Çayı ile meşhur karadeniz ili ? ";
            ...
            if (soruno == 19)
            {
                richTextBox1.Text = "Kangal Köpeği ile meşhur il ? ";
            ...
            if (soruno == 20)
            {
                richTextBox1.Text = "Günleri gösteren nesne ? ";
            ...
            if (soruno == 22)
            {
                richTextBox1.Text = "Gezegen ismi ? ";
            ...
            if (soruno == 23)
            {
                richTextBox1.Text = "Türkiye'de bir il ? ";
            ...
            if (soruno == 24)
            {
                richTextBox1.Text = "Akıp giden şey ? ";
